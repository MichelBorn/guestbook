...
class GuestbookEntry {
	...
	private final String name, text, bDate;
	 ...
	 */
	public GuestbookEntry(String name, String text,String bDate) {

		Assert.hasText(name, "Name must not be null or empty!");
		Assert.hasText(text, "Text must not be null or empty!");
		Assert.hasText(bDate, "Geburtstag must not be null or empty!");
		this.name = name;
		this.text = text;
		this.bDate = bDate;
